...
void main() {
  ...
  test('camera-path lines include locate/grid/wb stages', () {
    ...
    // The estimate is a tolerance-gated diagnostic (64 ± 10); the run-length module is ~1% noisy.
    expect(lines.any((l) => RegExp(r'^frame=0 stage=grid estimate=(5[4-9]|6[0-9]|7[0-4])$').hasMatch(l)), isTrue, reason: lines.join('\n'));
